...
export class Constants {
  ...
  public static readonly DEFAULT_PANEL_COLOR = p5.Color(0x00FF00);
  public static readonly ALTERNATE_PANEL_COLOR = p5.Color(0XFFDAB9);
  ...
  public static readonly GRAVITY = p5.createVector(0, 0.4);
  // gravity multiplier for jumping higher when holding jump button
  public static readonly WALL_SLIDE_ACCELERATION = p5.createVector(0, 0.1);
  ...
  public static readonly PLAYER_DEFAULT_COLOR = p5.Color(0x000000);
  public static readonly PLAYER_DAMAGED_COLOR = p5.Color(0x888888);
  public static readonly PLAYER_DIAMETER = 60;
  public static readonly PLAYER_HEALTH_TEXT_COLOR = p5.Color(0xFFFFF);
  ...
  public static readonly ENEMY_COLOR = p5.Color(0xFF0000);
  ...
  public static readonly BOUNDARY_COLOR = p5.Color(0x000000);
  public static readonly DEFAULT_BOUNDARY_LINE_THICKNESS = 1;

  public static readonly BREAKABLE_BLOCK_COLOR = p5.Color(0x800000);
  public static readonly DEFAULT_BLOCK_COLOR = p5.Color(0xCD853);
  public static readonly DEFAULT_BLOCK_SIZE = 100;

  public static readonly ITEM_BLOCK_TEXT_COLOR = p5.Color(0x000000);

  public static readonly EVENT_BLOCK_COLOR = p5.Color(0x00E500);
  public static readonly DEFAULT_EVENT_BLOCK_WIDTH = 125;
  public static readonly DEFAULT_EVENT_BLOCK_HEIGHT = 200;

  /*** collectable config ***/
  public static readonly CHECKPOINT_COLOR = p5.Color(0xFFD700);
  public static readonly CHECKPOINT_WIDTH = 40;
  public static readonly CHECKPOINT_HEIGHT = 100;

  public static readonly LEVEL_GOAL_COLOR = p5.Color(0xDCDCDC);
  public static readonly LEVEL_GOAL_WIDTH = 40;
  public static readonly LEVEL_GOAL_HEIGHT = Constants.LEVEL_FLOOR_Y_POSITION;

  public static readonly HEALTH_ITEM_COLOR = p5.Color(0xDCDCDC);
  public static readonly NEGATIVE_HEALTH_ITEM_TEXT_COLOR = p5.Color(0xFF0000);
  public static readonly ZERO_HEALTH_ITEM_TEXT_COLOR = p5.Color(0x888888);
  public static readonly POSITIVE_HEALTH_ITEM_TEXT_COLOR = p5.Color(0x008000);
